...
var datetime = ", Today is " + currentdate.getDate() + " " + mon[currentdate.getMonth()] + " " + currentdate.getFullYear() + "   " + hr + ":" + currentdate.getMinutes() + " "+ kp;
...
function chk2(){
        ...
        xhr.open('GET','https://codeforces.com/api/user.info?handles=buddy_king',false);
